...
{
    /// <summary>
    /// A generic message that is generated when any item is purchased.
    /// 
    /// FOr certain key items there are more specific messages that you can also listen for instead.
    /// </summary>
