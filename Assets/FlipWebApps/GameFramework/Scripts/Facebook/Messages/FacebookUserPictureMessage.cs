...
namespace GameFramework.Facebook.Messages
{
    ...
    /// </summary>
    public class FacebookUserPictureMessage : BaseMessage
    {
        public enum ResultType { ERROR, OK };
        ...
        public FacebookUserPictureMessage(ResultType result, Texture texture)
        {
            Result = result;
            Texture = texture;
        }
        ...
        {
            return string.Format("Facebook User Picture Message: {0}", Result);
        }
    }
}
