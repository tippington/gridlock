...
namespace GameFramework.Facebook.Components {
    /// <summary>
    /// Automatically hooks a button on click event to show a Facebook AppRequest dialog
    /// </summary>
    [RequireComponent(typeof(Button))]
    [AddComponentMenu("Game Framework/Facebook/OnButtonClickAppRequest")]
    [HelpURL("http://www.flipwebapps.com/game-framework/facebook/")]
    public class OnButtonClickAppRequest : OnButtonClick
    {
